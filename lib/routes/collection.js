...
var routes = function (config) {
  ...
  exp.apiDeleteCollection = function (req, res) {
    req.collection.drop(function (err) {
      if (err) {
        req.session.error = 'Something went wrong: ' + err;
        console.error(err);
  ...
  exp.apiAddCollection = function (req, res) {
    var name = req.body.collection;
  ...
  exp.apiRenameCollection = function (req, res) {
    var name = req.body.collection;
  ...
  // TODO: CLEAN UP THE PAGINATION
  exp.apiViewCollection = function (req, res) {
